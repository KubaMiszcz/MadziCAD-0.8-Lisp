		...
		:boxed_column{label = "Wyniki"; children_alignment = left; fixed_height =true; fixed_width = true; children_fixed_width = true; children_fixed_height = true;
			:row {
				...
				:column {children_alignment = centered;
					...
					:row {
					:edit_box {label = ""; key = "ea"; edit_width = 3 ; alignment = centered; is_tab_stop = true;}
						spacer_1;
					}
					:text {label = "1000.00"; key = "na"; }
					:text {label = "100.00"; key = "pole_a"; }	
					:text {label = "100.00"; key = "Jx_a"; }
					//spacer_1;
					:button {label = "< Wska¿"; key = "wskaz_obszar_a"; fixed_width =true;alignment = centered; is_tab_stop = true;}
					//spacer_1;
				}
					spacer_1;
				:column {children_alignment = centered;
					...
					:row {
						:edit_box {label = ""; key = "eb"; edit_width = 3 ; alignment = centered; is_tab_stop = true;}
						spacer_1;
					}
					:text {label = "1000.00"; key = "nb"; }
					:text {label = "100.00"; key = "pole_b"; }	
					:text {label = "100.00"; key = "Jx_b"; }
					:button {label = "< Wska¿"; key = "wskaz_obszar_b"; fixed_width =true;alignment = centered; is_tab_stop = true;}
				}
					spacer_1;
				:column {children_alignment = centered;
					:text {label = "Przekrój C"; }	
					:row {
						:edit_box {label = ""; key = "ec"; edit_width = 3 ; alignment = centered; is_tab_stop = true;}
						spacer_1;
					}
					:text {label = "1000.00"; key = "nc"; }
					:text {label = "100.00"; key = "pole_c"; }	
					:text {label = "100.00"; key = "Jx_c"; }
					:button {label = "< Wska¿"; key = "wskaz_obszar_c"; fixed_width =true;alignment = centered; is_tab_stop = true;}
				}
				spacer_1;
				:column {children_alignment = centered;
					:text {label = "Przekrój D"; }	
					:row {
						:edit_box {label = ""; key = "ed"; edit_width = 3 ; alignment = centered; is_tab_stop = true;}
						spacer_1;
					}
					:text {label = "1000.00"; key = "nd"; }
					:text {label = "100.00"; key = "pole_d"; }	
					:text {label = "100.00"; key = "Jx_d"; }
					:button {label = "< Wska¿"; key = "wskaz_obszar_d"; fixed_width =true;alignment = centered; is_tab_stop = true;}
				}
				spacer_1;
			}
		:spacer {height = 0.1;}
			...
			spacer_1;
				...
				:row {children_alignment = centered;
					...
					:column{children_alignment = right;
						...
						:text {label = "1000000.00"; key = "Jx_zespolonego";}
						spacer_1;
					}
				}
			}
	...
	:row {alignment = centered; fixed_height =true;fixed_width = false; children_alignment = top;
		:boxed_column{label = "Wyniki"; children_alignment = left; fixed_height =true;fixed_width = false;
			:row {
				...
				:column {children_alignment = right;
					:text {label = "Przekrój D"; }	
					:text {label = "100.00"; key = "moment_zginajacy_d"; }
					:text {label = "1000.00"; key = "sila_osiowa_d"; }
					spacer_1;
					:text { }	
					:text {label = "100.00"; key = "sigma_gw_d"; }	
					:text {label = "100.00"; key = "sigma_dw_d"; }
				}
				spacer_1;
			}
			spacer_1;
...
przekroj_zespolony_info : dialog {label = "MadziCAD Info";
	:column {children_alignment = centered; fixed_width = true; fixed_height = true;
		spacer_1;
		:text {label = "MadziCAD - PRZEKRÓJ ZESPOLONY v0.9";}
		spacer_1;
		:text {label = "(c) Kuba Be³ch 2008";}
